            ...
            <Container>
                <Comp>
                    ...
                    <Right>
                        ...
                        <ProgressBar lang='Html' per=''/>
                        <ProgressBar lang='Css' per=''/>
                        <ProgressBar lang='Javascript' per=''/>
                        <ProgressBar lang='C++' per=''/>
                        <ProgressBar lang='React' per=''/>
                        <ProgressBar lang='Express' per=''/>
                        <ProgressBar lang='MongoDb' per=''/>
                        <ProgressBar lang='Firebase' per=''/>
